...
if (!unreleased_section.includes("### Changed"))
  missing_categories.push("Changed");
if (!unreleased_section.includes("### Deprecated"))
  missing_categories.push("Deprecated");
if (!unreleased_section.includes("### Removed"))
  missing_categories.push("Removed");
if (!unreleased_section.includes("### Fixed")) missing_categories.push("Fixed");
if (!unreleased_section.includes("### Security"))
  missing_categories.push("Security");
```

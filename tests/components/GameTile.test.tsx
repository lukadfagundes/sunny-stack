...
describe("GameTile", () => {
  it("renders an empty tile with correct label", () => {
    render(
      <GameTile type="empty" isPlayer={false} isGoal={false} row={0} col={0} />,
    );
  ...
  it("renders player tile with correct label", () => {
    render(
      <GameTile type="empty" isPlayer={true} isGoal={false} row={0} col={0} />,
    );
  ...
  it("renders sake tile with correct label", () => {
    render(
      <GameTile type="sake" isPlayer={false} isGoal={false} row={0} col={0} />,
    );
